...
Hooks:PostHook( HUDMissionBriefing, "init", "ascension_bg", function(self, hud, workspace)
	local show_contact_gui = true
	if managers.job:current_level_id() == "ascension_III" then
		self:set_pattern_no_movement("guis/ascension_bd", 1, "add")
